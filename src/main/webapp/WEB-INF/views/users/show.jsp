...
<c:set var="actEmp" value="${ForwardConst.ACT_USE.getValue()}" />
...
<c:import url="/WEB-INF/views/layout/app.jsp">
    <c:param name="content">
        ...
        <h2>id : ${user.name} のユーザー情報 詳細ページ</h2>
        ...
        <p>
            <a href="<c:url value='?action=${actEmp}&command=${commEdit}&id=${user.id}' />">アカウント情報を編集する</a>
        </p>
