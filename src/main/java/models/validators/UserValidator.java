...
public class UserValidator {
    ...
    public static List<String> validate(
        ...
        //ユーザーIDのチェック
        String codeError = validateId(service, ev.getId(), codeDuplicateCheckFlag);
        if (!codeError.equals("")) {
     ...
     * @return エラーメッセージ
     */
    private static String validateId(UserService service, String code, Boolean codeDuplicateCheckFlag) {
        ...
        if (codeDuplicateCheckFlag) {
            ...
            long employeesCount = isDuplicateUser(service, code);
    ...
    private static long isDuplicateUser(UserService service, String code) {
        ...
        long employeesCount = service.countById(code);
